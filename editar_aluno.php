  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i>Actualizar Aluno</h3>
            <ol class="breadcrumb">
...
?>
 <form method="POST" action="actualizar_aluno.php">

              <div class="row">
                <!-- LINHA -->
               <div class="row">
            <div class="form-group">
                <input type="hidden" name="id" value="<?php echo $dados['id_aluno']; ?>" class="form-control" />
              </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label>Nome Completo</label>
                    <input type="text" name="nome_aluno" value="<?php echo $dados['nome_completo']; ?>" class="form-control" />
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="num" name="num_aluno" value="<?php echo $dados['num_aluno']; ?>" class="form-control" />
                  </div>
                </div>
                 ...
                 <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="area_formacao" value="<?php echo $dados['area_formacao']; ?>" class="form-control" />
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="num_processo" value="<?php echo $dados['num_proc']; ?>" class="form-control" />
                  </div>
                </div>
                 ...
                 <button type="submit" name="btn-actualizar" class="btn btn-primary"><i class="fa fa-save"></i> Actualizar</button>
                  <a href="cadastrar_aluno.php" class="btn btn-danger" >Voltar</a>
