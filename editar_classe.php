  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i>Editar Classe</h3>
            <ol class="breadcrumb">
...
?>
 <form action="actualizar_classe.php" method="POST">
            <div class="row">
            <div class="form-group">
                <input type="hidden" name="id" value="<?php echo $dados['id_classe']; ?>" class="form-control" />
              </div>
              <div class="col-md-6">
                  <div class="form-group">
                    <label>Nível da Classe</label>
                    <input type="text" name="nivel_classe" value="<?php echo $dados['nome_classe']; ?>"  class="form-control" />
                    
                  </div>

                
                 <button type="submit" name="btn-actualizar" class="btn btn-primary"><i class="fa fa-save"></i> Actualizar</button>
                  <a href="cadastrar_classe.php" class="btn btn-danger" >Voltar</a>
