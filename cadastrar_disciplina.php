  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i>Cadastrar Disciplina</h3>
              <?php 
        ...
        <div class="row">
          ...
          <button type="submit" name="btn-disciplina" class="btn btn-primary"><i class="fa fa-save"></i> Cadastrar</button> 
...
<table class="table table-striped table-advance table-hover">
                <tbody>
                  ...
                  <?php
                  $sql = "SELECT d.id_disciplina, d.id_curso, d.id_classe, d.nome_dis,c.nome, l.nome_classe
                    FROM disciplina d INNER JOIN curso c 
                    ON d.id_curso = c.id_curso JOIN classe l ON d.id_classe = l.id_classe  ORDER BY id_disciplina ";

                  $resultado = mysqli_query($connect, $sql);
                  while($dados = mysqli_fetch_array($resultado)):
                  ?>
                  <tr>
                    <td><?php echo $dados['id_disciplina']; ?></td>
                    <td><?php echo $dados['nome_dis']; ?></td>
                    <td><?php echo $dados['nome']; ?></td>
                    <td><?php echo $dados['nome_classe']; ?></td>
                    <td>
                      <div class="btn-group">
                        <a class="btn btn-primary" href="editar_disciplina.php?id=<?php echo $dados['id_disciplina']; ?>"><i class="icon_plus_alt2"></i></a>
                      
                        <a class="btn btn-danger" href="delectar_disciplina.php?id=<?php echo $dados['id_disciplina']; ?>"><i class="icon_close_alt2"></i></a>
                      </div>
                    </td>
                  </tr>
                <?php endwhile; ?>
