  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i>Editar Turma</h3>
            <ol class="breadcrumb">
...
?>
 <form action="actualizar_turma.php" method="POST">
            <div class="row">
            <div class="form-group">
                <input type="hidden" name="id" value="<?php echo $dados['id_turma']; ?>" class="form-control" />
              </div>
              <div class="col-md-6">
                  <div class="form-group">
                    <label>Nome da Turma</label>
                    <input type="text" name="nome_turma" value="<?php echo $dados['nome_turma']; ?>" placeholder="Nome da Turma" class="form-control" />
                    </div>
                  </div>
                  <div class="col-md-6">
                  <div class="form-group">
                    <label>Director Turma</label>
                    <input type="text" name="director_turma" value="<?php echo $dados['director_turma']; ?>" placeholder="Nome da Turma" class="form-control" />
                    </div>
                  </div>

                
                 <button type="submit" name="btn-actualizar" class="btn btn-primary"><i class="fa fa-save"></i> Actualizar</button>
                  <a href="cadastrar_turma.php" class="btn btn-danger" >Voltar</a>
