  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i>Registar Utilizadores</h3>
              <?php 
        ...
        ?>
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-file-text-o"></i>Registar utilizadores</li>
            </ol>
          </div>
        </div>
        <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="num" name="bi" placeholder="digite o seu número do BI" maxlength="14" class="form-control"  />  
                </div>
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input type="num" name="telefone" placeholder="digite o seu número de telefone" maxlength="9" class="form-control">
                </div>
              </div>
               <div class="col-sm-6">
                <div class="form-group">
                  <label>Tipo de utilizador</label>
                  <input type="text" name="tipo" placeholder="Administrador"  autocomplete="off" list="Utilizadores" class="form-control">
        ...
        <option value="Professor"></option>
                 ...
                 <button type="submit" name="btn-cadastrar" class="btn btn-primary"><i class="fa fa-save"></i> Cadastrar</button> 
              </div>  
          </div> </br></br>
           </form>
