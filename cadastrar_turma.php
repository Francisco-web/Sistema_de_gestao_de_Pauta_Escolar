  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i>Cadastrar Turmas</h3>
              <?php 
        ...
        ?>
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-file-text-o"></i>Turma</li>
            </ol>
          </div>
        </div>
        <div class="row">
            ...
            <div class="row">
              <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="nome_turma"  autocomplete="off" class="form-control" />
                    
                  </div>
                  
                  <div class="form-group">
                    <label>Director de Turma</label>
                    <input type="text" name="director_turma" autocomplete="off" class="form-control" />
                    
                  </div>
                
                 <button type="submit" name="btn-turma" class="btn btn-primary"><i class="fa fa-save"></i> Cadastrar</button> 
              </div>  
          </div> </br></br>
           </form>
 ...
 <table class="table table-striped table-advance table-hover">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo $dados['director_turma']; ?></td>
                    <td>
                      <div class="btn-group">
                        <a class="btn btn-primary" href="editar_turma.php?id=<?php echo $dados['id_turma']; ?>"><i class="icon_plus_alt2"></i></a>
                      
                        <a class="btn btn-danger" href="delectar_turma.php?id=<?php echo $dados['id_turma']; ?>"><i class="icon_close_alt2"></i></a>
                      </div>
                    </td>
                  </tr>
                <?php endwhile; ?>
