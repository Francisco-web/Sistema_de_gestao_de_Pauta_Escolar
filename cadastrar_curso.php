  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i>Cadastrar Cursos</h3>
              <?php 
        ...
        ?>
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-file-text-o"></i>Curso</li>
            </ol>
          </div>
        </div>
        <div class="row">
          ...
          <form action="curso.php" method="POST">
            <div class="row">
              <div class="col-md-6">
                 ...
                 <button type="submit" name="btn-curso" class="btn btn-primary"><i class="fa fa-save"></i> Cadastrar</button> 
              </div>  
          </div> </br></br>
           </form>
...
<table class="table table-striped table-advance table-hover">
                <tbody>
                  ...
                  ?>
                  <tr>
                    <td><?php echo $dados['id_curso']; ?></td>
                    <td><?php echo $dados['nome']; ?></td>
                    <td><?php echo $dados['coordenador']; ?></td>
                    <td>
                      <div class="btn-group">
                        <a class="btn btn-primary" href="editar_curso.php?id=<?php echo $dados['id_curso']; ?>"><i class="icon_plus_alt2"></i></a>
                      
                        <a class="btn btn-danger" href="delectar_curso.php?id=<?php echo $dados['id_curso']; ?>"><i class="icon_close_alt2"></i></a>
                      </div>
                    </td>
                  </tr>
                <?php endwhile; ?>
