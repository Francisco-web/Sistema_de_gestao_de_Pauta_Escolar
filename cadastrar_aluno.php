  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i>Cadastrar Aluno</h3>
              <?php 
        ...
        ?>
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-file-text-o"></i>Aluno</li>
            </ol>
          </div>
        </div>
        <div class="row">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="num" name="num_aluno" class="form-control" />
                  </div>
                </div>
                 <div class="col-md-6">
                  <div class="form-group">
                    <label>Area de Formação</label>
                    <input type="text" name="area_formacao" class="form-control" />
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                ...
                <?php } ?>
                 ...
                 <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="num" name="num_processo" class="form-control" />
                  </div>
                </div>
              <div class="col-md-6">
                  <div class="form-group">
          ...
          <button type="submit" name="btn-aluno" class="btn btn-primary"><i class="fa fa-save"></i> Cadastrar</button> 
              </div>
            </form> </br>
...
<table class="table table-striped table-advance table-hover">
                <tbody>
                  ...
                  <?php
                  $sql = "SELECT a.id_aluno, a.id_curso, a.id_turma, a.num_aluno, a.nome_completo,a.num_proc,a.area_formacao,c.nome, t.nome_turma
                    FROM aluno a INNER JOIN curso c 
                    ON a.id_curso = c.id_curso JOIN turma t ON a.id_turma = t.id_turma  ORDER BY num_aluno ";
                  ...
                  <tr>
                    ...
                    <td><?php echo $dados['area_formacao']; ?></td>
                    <td><?php echo $dados['nome']; ?></td>
                    <td>
                      <div class="btn-group">
                        <a class="btn btn-primary" href="editar_aluno.php?id=<?php echo $dados['id_aluno']; ?>"><i class="icon_plus_alt2"></i></a>
                      
                        <a class="btn btn-danger" href="delectar_aluno.php?id=<?php echo $dados['id_aluno']; ?>"><i class="icon_close_alt2"></i></a>
                      </div>
                    </td>
                  </tr>
                <?php endwhile; ?>
