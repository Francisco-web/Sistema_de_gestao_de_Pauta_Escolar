  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i>Editar Curso</h3>
            <ol class="breadcrumb">
...
?>
 <form action="actualizar_curso.php" method="POST">
            ...
            <div class="form-group">
                <input type="hidden" name="id" value="<?php echo $dados['id_curso']; ?>" class="form-control" />
              </div>
              <div class="col-md-6">
                  <div class="form-group">
                    <label>Nome do Curso</label>
                    <input type="text" name="nome_curso" value="<?php echo $dados['nome']; ?>"  class="form-control" />
                    </div>
                  </div>
                  <div class="col-md-6">
                  <div class="form-group">
                    <label>Coordenador</label>
                    <input type="text" name="coordenador" value="<?php echo $dados['coordenador']; ?>"  class="form-control" />
                    </div>
                    </div>
                 <button type="submit" name="btn-actualizar" class="btn btn-primary"><i class="fa fa-save"></i> Actualizar</button>
                  <a href="cadastrar_curso.php" class="btn btn-danger" >Voltar</a>
