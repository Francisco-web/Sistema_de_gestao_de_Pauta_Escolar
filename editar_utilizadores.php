  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i>Editar Utilizadores</h3>
            <ol class="breadcrumb">
...
?>
 <form action="actualizar_utilizadores.php" method="POST">
            <div class="row">
            <div class="form-group">
                <input type="hidden" name="id" value="<?php echo $dados['id_utilizador']; ?>" class="form-control" />
              </div>
              <div class="col-md-6">
                  <div class="form-group">
                    <label>Nome Completo</label>
                    <input type="text" name="nome" value="<?php echo $dados['nome_completo']; ?>" placeholder="Nome completo" class="form-control" />
                    
                  </div>

                <div class="form-group">
                  <label>Email</label>
                  <input type="email" name="email" value="<?php echo $dados['email']; ?>" placeholder="digite o seu email" class="form-control" />                
                </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="num" name="bi" value="<?php echo $dados['num_bi']; ?>" placeholder="digite o seu número do BI" class="form-control"  />  
                </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label>Senha</label>
                  <input type="password" name="senha" value="<?php echo $dados['senha']; ?>" placeholder="digite a sua senha" class="form-control"> 
                </div>
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input type="num" name="telefone" value="<?php echo $dados['telefone']; ?>" placeholder="digite o seu número de telefone" class="form-control">
                </div>
              </div>
               ...
               <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input type="text" name="tipo" value="<?php echo $dados['tipo']; ?>" placeholder="Administrador" list="Utilizadores" class="form-control">
                   <datalist id="Utilizadores">
        <option value="Admistrador"></option>
        <option value="Professor"></option>
        <option value="Coordenacao"></option>
        <option value="D.Pedagógico"></option>
        <option value="D.Turma"></option> 

                </div>
                 <button type="submit" name="btn-actualizar" class="btn btn-primary"><i class="fa fa-save"></i> Actualizar</button>
                  <a href="consultar_utilizador.php" class="btn btn-danger" >Voltar</a>
